...
<body>
	<!-- <div class="topnav">
		<a class="active" href="/Orion">Orion</a>
		<div class="nav">
			<a href="exams.html">Competitive exams </a> <a href="colleges.html">Colleges
				and Universities</a>
		</div>
		...
		<div class="container">
			<form method="POST" class="appointment-form" id="appointment-form"
				...
				<div class="form-group-1">
					<div class="form-radio">
						<input type="radio" name="member_level" value="0" id="student"
							checked="checked" /> <label for="student">Student</label> <input
							type="radio" name="member_level" value="1" id="teacher" /> <label
							for="teacher">Teacher</label> <input type="radio"
							name="member_level" value="2" id="professional" /> <label
							for="professional">Professional</label>
					</div>
					<input type="text" name="title" id="title" placeholder="Title"
						required /> <input type="text" name="name" id="name"
						placeholder="Your Name" required /> <input type="number"
						name="phone_number" id="phone_number" placeholder="Phone number"
						required /> <input type="email" name="email" id="email"
						placeholder="Email" onblur="ValidateEmail()" required /> <input
				...
				<div class="form-group-2">
					...
					<div class="select-list">
						<select name="confirm_type" id="confirm_type">
							<option selected value="by_phone">By phone</option>
					...
					<div class="form-check">
						<input type="checkbox" name="agree-term" id="agree-term"
							...
							agree to the <a data-toggle="modal" href="#myModal"
							target="_blank" class="term-service">Terms and Conditions</a></label>
					</div>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title" style="color: black;">Terms and
									Conditions</h4>
							</div>
							<div class="modal-body">
								<p>Welcome to Orion!</p>

								<p>These terms and conditions outline the rules and
									regulations for the use of Orion Inc's Website, located at
									http://localhost:8080/Orion.</p>

								<p>By accessing this website we assume you accept these
									terms and conditions. Do not continue to use Orion if you do
								...
								<p>We employ the use of cookies. By accessing Orion, you
									agreed to use cookies in agreement with the Orion Inc's Privacy
									Policy.</p>

								<p>Most interactive websites use cookies to let us retrieve
								...
								<p>Unless otherwise stated, Orion Inc and/or its licensors
									own the intellectual property rights for all material on Orion.
									All intellectual property rights are reserved. You may access
									this from Orion for your own personal use subjected to
									restrictions set in these terms and conditions.</p>

								<p>You must not:</p>
								<ul style="color:black;">
									<li>Republish material from Orion</li>
									<li>Sell, rent or sub-license material from Orion</li>
									<li>Reproduce, duplicate or copy material from Orion</li>
									<li>Redistribute content from Orion</li>
								</ul>
								...
								<p>Orion Inc reserves the right to monitor all Comments and
								...
								<p>You hereby grant Orion Inc a non-exclusive license to
								...
								<p>The following organizations may link to our Website
								...
								<p>These organizations may link to our home page, to
									...
									and its products and/or services; and (c) fits within the
								...
								<p>We will approve link requests from these organizations if
									we decide that: (a) the link would not make us look unfavorably
									...
									compensates the absence of Orion Inc; and (d) the link is in
									the context of general resource information.</p>

								<p>These organizations may link to our home page so long as
									the link: (a) is not in any way deceptive; (b) does not falsely
									imply sponsorship, endorsement or approval of the linking party
									and its products or services; and (c) fits within the context
								...
								<p>If you are one of the organizations listed in paragraph 2
									...
									inform us by sending an e-mail to Orion Inc. Please include
								...
								<ul>
									...
									<li>By use of the uniform resource locator being linked
										to; or</li>
									<li>By use of any other description of our Website being
										linked to that makes sense within the context and format of
										content on the linking party’s site.</li>
								</ul>

								<p>No use of Orion Inc's logo or other artwork will be
								...
								<p>Without prior approval and written permission, you may
								...
								<p>We shall not be hold responsible for any content that
									appears on your Website. You agree to protect and defend us
									against all claims that is rising on your Website. No link(s)
								...
								<p>We reserve the right to request that you remove all links
									or any particular link to our Website. You approve to
									immediately remove all links to our Website upon request. We
									also reserve the right to amen these terms and conditions and
								...
								<p>If you find any link on our Website that is offensive for
								...
								<p>To the maximum extent permitted by applicable law, we
									exclude all representations, warranties and conditions relating
									to our website and the use of this website. Nothing in this
									disclaimer will:</p>
								...
								<ul>
									...
									<li>limit any of our or your liabilities in any way that
										is not permitted under applicable law; or</li>
								...
								<p>As long as the website and the information and services
				...
				<div class="text-center p-t-136">
					<a class="txt2" href="UserLogin"> Already have an account ? <i
